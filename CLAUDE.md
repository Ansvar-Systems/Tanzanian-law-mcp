# Tanzania Law MCP Server — Developer Guide
...
Tanzania Law MCP server providing Tanzanian legislation search via Model Context Protocol. Strategy A deployment (Vercel, bundled SQLite DB). Covers data protection, cybercrimes, ICT, companies, consumer protection, and other key Acts.
...
- Tanzania uses "Section N" for Acts and "Article N" for the Constitution
...
1. `scripts/ingest.ts` -> fetches from Tanzania Law -> JSON seed files in `data/seed/`
...
- **Tanzania Law** (tanzanialaw.org) -- National Council for Law Reporting
- **License:** Government Open Data
- **Languages:** English (en) is the primary legal language; Swahili (sw) for some documents
- **Coverage:** All Acts of Parliament, subsidiary legislation, Constitution of Tanzania 2010, selected case law

## Tanzania-Specific Notes

- Tanzania uses a common law legal system inherited from British colonial administration
- The Constitution of Tanzania 2010 is the supreme law (Article 2)
...
- For the Constitution: "Article N, Constitution of Tanzania 2010"
...
- npm package: `@ansvar/tanzania-law-mcp` with bin entry for stdio
